...
*
* \brief      Fonction objallocate : allocation de mémoire pour chaque objet
* \details    Cette fonction autilise la fonction système "malloc"
* \param      k             un OBJECT.
* \param      n             un entier.
...
*
* \brief      Fonction objallocate : désallocation de mémoire pour chaque objet
* \details    Cette fonction utilise la fonction système "free"
* \param      k             un OBJECT.
* \return     void          un void (aucun retour).
*
*/
...
/**	            This Code lit les chaînes de caractères d'un fichier
*
* \brief      Fonction readstr : lecture des chaînes de caractères d'un fichier
* \details    Cette fonction utilise la fonction système "fgets"
* \param      f             un FILE (nom d'un fichier).
* \param      string        la chaîne de caractère lue.
* \return     void          un void (aucun retour).
*
*/
...
/**	            This Code lit les chaînes de caractères d'un fichier
*
* \brief      Fonction objload : Chargement des objets à partir d'un fichier
* \details    Cette fonction utilise la fonction système "fgets"
* \param      name          le nom d'un fichier.
* \param      k             l'objet décrit dans le fichier
* \return     void          un void (aucun retour).
*
*/
